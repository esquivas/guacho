...
module parameters
  ...
  real, parameter :: xphys=24.1*pc/2. !< grid extent in X (physical units, cgs)

  !  For the equation of state
  real, parameter :: cv=1.3            !< Specific heat at constant volume (/R)
  ...
  real, parameter :: dtprint =  tmax/20.
