...
module parameters
  ...
  integer, parameter :: nxtot=880      !< Total grid size in X
  integer, parameter :: nytot=176      !< Total grid size in Y
  integer, parameter :: nztot=440      !< Total grid size in Z

#ifdef MPIP
  !   mpi array of processors
  integer, parameter :: MPI_NBX=5     !< number of MPI blocks in X
  ...
  real, parameter :: ymax=0.2          !< grid extent in Y (code units)
  real, parameter :: zmax=0.5          !< grid extent in Z (code units)
  real, parameter :: xphys=0.15*au     !< grid extent in X (physical units, cgs)
  ...
  integer            :: itprint0=118 !< number of output to do warm start
