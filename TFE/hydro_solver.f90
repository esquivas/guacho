...
subroutine tstep()
  ...
  if (twofluid) then
    ...
    !call add_TF_sources(up,upn,primit,primitn,dtm)
    !  twofluid step for momenta and energy
    call update_TF(u,un,up,upn,primit,primitn,dtm)
  end if
  ...
  if (twofluid) then
    ...
    ! add sources
    !call add_TF_sources(up,upn,primit,primitn,dt_CFL)
    call update_TF(u,un,up,upn,primit,primitn,dt_CFL)
  end if
#endif
