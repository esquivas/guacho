...
subroutine init_difrad()
  ...
  !  on error
  allocate (photL(2,7,nrays/2))
  allocate (photR(2,7,nrays/2))
  allocate (photB(2,7,nrays/2))
  allocate (photT(2,7,nrays/2))
  allocate (photO(2,7,nrays/2))
  allocate (photI(2,7,nrays/2))
...
!    zc=float(nztot/2)*dz
  ...
  do niter=1, nrays
     ...
     !
     f=5.e46  !  flujo de fotones ionizantes:not divided by np
!       f=nphot
