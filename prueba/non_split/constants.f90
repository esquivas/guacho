...
module constants
  ...
  integer, parameter :: SOLVER_HLL_SPLIT_ALL = 5
  integer, parameter :: SOLVER_HLLC_SPLIT_ALL = 6
  integer, parameter :: SOLVER_HLLE_SPLIT_B = 7
  integer, parameter :: SOLVER_HLLD_SPLIT_B = 8
  integer, parameter :: SOLVER_HLLE_SPLIT_ALL = 9
  integer, parameter :: SOLVER_HLLD_SPLIT_ALL = 10
