...
module parameters
  ...
  character (len=128),parameter ::  outputpath='./hd/2temp/'
  !> working directory
  ...
  integer, parameter :: riemann_solver = SOLVER_HLL_SPLIT_ALL
  ...
  real, parameter :: mu = 0.6           !< mean atomic mass
  ...
  real, parameter :: Tempsc=gamma*T0              !<  Temperature scaling
