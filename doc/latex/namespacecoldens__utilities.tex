...
\hypertarget{namespacecoldens__utilities_ab85f0688ddbdcef34c8ed7f53c3071c5}{}\index{coldens\+\_\+utilities@{coldens\+\_\+utilities}!write\+\_\+header@{write\+\_\+header}}
\index{write\+\_\+header@{write\+\_\+header}!coldens\+\_\+utilities@{coldens\+\_\+utilities}}
\subsubsection[{write\+\_\+header}]{\setlength{\rightskip}{0pt plus 5cm}subroutine coldens\+\_\+utilities\+::write\+\_\+header (
\begin{DoxyParamCaption}
\item[{integer, intent(in)}]{unit, }
\item[{integer, intent(in)}]{nx, }
\item[{integer, intent(in)}]{ny}
\end{DoxyParamCaption}
)}\label{namespacecoldens__utilities_ab85f0688ddbdcef34c8ed7f53c3071c5}
