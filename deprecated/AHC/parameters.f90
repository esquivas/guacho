...
module parameters
  ...
  character (len=128),parameter ::  outputpath='/datos/esquivel/guacho-working/AHC-M1AD/'
  !> working directory
  ...
  real, parameter :: mu = 1.           !< mean atomic mass (only H fully ionized)
  ...
  integer            :: itprint0=23  !< number of output to do warm start
