...
!  bsw   = 1.0                            ! Stellar magnetic field (g)
  ...
  !----------------PLANET PARAMETERS------------------
!  MassP = 0.67*mjup
  dsw=100.*1.3*1.66e-24
  AMPDOT= 1.E-5*msun/yr   !***********         ! Planetary Mass Loss rate (g/s)
  TPW   = 1E5                          ! Planets temperature
  RPW   = 2.e16                 ! Planetary wind radius (cm) 
  vpw   = 500.e5                        ! Planets wind velocity (cm/s)
  dpw=((AMPDOT/RPW)/(4*pi*RPW*VPW))    ! Planetary wind density
  bpw   = 0.00                         ! Planetary magnetic field (g)
