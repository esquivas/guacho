...
#        Psi= Phi*denN+1e-30    
    ...
    images=[denT,denN,temp,Pgas,denT,denT,denT,magv,denT]

    cmaps=['Blues_r','Blues','gist_heat','jet','gist_heat','jet' ,'seismic','jet','Spectral']
    
    minVs=[1e-20,  100, 1e4, 1E-15, 1e-8, 1e-4 , 0,    0 , 1e4 ]
    maxVs=[1e20, 1e10, 1e5, 1e-11, 1e-4, 1e1  , 1., 600 , 1e11]
