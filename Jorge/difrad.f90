...
contains
  ...
  subroutine init_difrad()
    ...
    allocate (photL(2,7,Nstars*nrays))
    allocate (photR(2,7,Nstars*nrays))
    allocate (photB(2,7,Nstars*nrays))
    allocate (photT(2,7,Nstars*nrays))
    allocate (photO(2,7,Nstars*nrays))
    allocate (photI(2,7,Nstars*nrays))
  ...
  subroutine diffuse_rad()
    ...
    use stars, only     : Nstars, Rw, xstar, ystar, zstar, sstar
    implicit none
    ...
    do ist=1, Nstars
      ...
      do niter=1, nrays
        ...
        !
        f=sstar(ist)   !  flujo de fotones ionizantes:not divided by np
